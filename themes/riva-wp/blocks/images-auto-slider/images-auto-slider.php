...
acf_register_block_type(
	array(
		'name'            => 'images-auto-slider',
		'title'           => __('Image Auto Slider'),
		'description'     => __('A carousel for displaying multiple images.'),
		...
		'example'         => array(
			'attributes' => array(
				'mode' => 'preview',
				'data' => array(
					'preview_image_help' => get_template_directory_uri() . '/blocks/images-auto-slider/preview/preview.png',
				),
			),
		),
	)

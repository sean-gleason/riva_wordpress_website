...
$cfg['blowfish_secret']					= '9CD(y^)_I\'aT<1})9HY;dj\'XjAvMu1Si' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_69rCOPhb280cj3ntNWJMdzx/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://35.171.140.106/wp-admin/?rand=50454645&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://35.171.140.106/wp-admin/?rand=50537576&pma_logout=1';
